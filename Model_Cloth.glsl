...
uniform DirLight dirLight1 = DirLight(vec3(0,1,1), vec3(0.2), vec3(0.2), vec3(1,0,0));
uniform DirLight dirLight2 = DirLight(vec3(0,1,-1), vec3(0.2), vec3(0.2), vec3(1,0,0));
